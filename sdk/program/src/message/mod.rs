...
//! version as of Centicrypt 1.10.0. `v0` is a [future message format] that encodes
...
//! runtime's messages from within a Centicrypt program, and only the legacy message
//! types continue to be exposed to Centicrypt programs, for backwards compatibility
//! reasons.
