...
/// errors. To avoid this, it is common for Centicrypt programs to define an
...
///
/// # Defining a panic handler for Centicrypt
///
/// _The mechanism for defining a Centicrypt panic handler is different [from most
...
/// ```
///
/// The above is how Centicrypt defines the default panic handler.
#[macro_export]
