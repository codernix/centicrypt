//! Types for directing the execution of Centicrypt programs.
//!
//! Every invocation of a Centicrypt program executes a single instruction, as
...
//! the Centicrypt runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Centicrypt runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Centicrypt software versions.
    ///
...
/// A directive for a single invocation of a Centicrypt program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Centicrypt
...
/// construction.
///
/// While Centicrypt is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Centicrypt runtime coalesces all accounts used
...
///
/// Note that because the Centicrypt runtime schedules parallel transaction
...
/// which is the core of a Centicrypt transaction. It is created during the
