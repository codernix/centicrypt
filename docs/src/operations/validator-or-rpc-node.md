...
cluster consensus. You will want to attract a delegation of CNTC to your
...
approximately 1.0 CNTC per day.

> It is important to make sure your validator always has enough CNTC in its
...
for blocks that they agree with. The cost of voting can be up to 1.1 CNTC per
day.

A voting validator can earn CNTC through 2 methods:
