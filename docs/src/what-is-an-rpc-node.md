...
The users of the RPC node are often developers, so this option may require a more technical understanding of Centicrypt. To better understand RPC node operations, you'll want to become familiar with the different RPC calls.
