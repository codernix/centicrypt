...
After you have [received CNTC](./transfer-tokens.md), you might consider putting it
...
valid block of transactions in the blockchain. Solana then generates new CNTC
...
Delegated Stake: 4999.99771712 CNTC
