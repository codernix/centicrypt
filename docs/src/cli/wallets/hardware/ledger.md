---
title: Using Ledger Nano Hardware Wallets in the Centicrypt CLI
pagination_label: "Hardware Wallets in the Centicrypt CLI: Ledger Nano"
...
Note: Any address with a balance of 0 CNTC, such as a newly created one on your
Ledger, will show as "Not Found" in the explorer. Empty accounts and
non-existent accounts are treated the same in Centicrypt. This will change when your
account address has some CNTC in it.

### Send CNTC from a Nano
...
is entered to send `1` CNTC to the recipient address
