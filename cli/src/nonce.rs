    ...
    fn nonce_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-nonce-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help(
                            "The amount to load the nonce account with, in CNTC; accepts keyword \
                             ALL",
                        ),
                )
                .arg(pubkey!(
        ...
        .subcommand(
            SubCommand::with_name("withdraw-from-nonce-account")
                .about("Withdraw CNTC from the nonce account")
                .arg(pubkey!(
                    Arg::with_name("nonce_account_pubkey")
                        .index(1)
                        .value_name("NONCE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .validator(is_amount)
                        .help("The amount to withdraw from the nonce account, in CNTC"),
                )
                .arg(nonce_authority_arg())
                .arg(memo_arg())
                .arg(compute_unit_price_arg()),
