    ...
    fn stake_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-stake-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help(
                            "The amount to send to the stake account, in CNTC; accepts keyword ALL",
                        ),
                )
                .arg(pubkey!(
            ...
            SubCommand::with_name("split-stake")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The amount to move into the new stake account, in CNTC"),
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
        ...
        .subcommand(
            SubCommand::with_name("withdraw-stake")
                .about("Withdraw the unstaked CNTC from the stake account")
                .arg(pubkey!(
                    Arg::with_name("stake_account_pubkey")
                        .index(1)
                        .value_name("STAKE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help(
                            "The amount to withdraw from the stake account, in CNTC; accepts \
                             keyword ALL",
                        ),
                )
                .arg(
            ...
            SubCommand::with_name("stake-account")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display balance in lamports instead of CNTC"),
                )
                .arg(
            ...
            SubCommand::with_name("stake-minimum-delegation")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display minimum delegation in lamports instead of CNTC"),
                ),
        )
    }
}
